...
export default class MenuStatusWindow extends BaseWindow {
  ...
  refresh() {
    ...
    this.setText('characterWeapon', hero.weapon.item.name)
    this.setText('characterBody', hero.body.item.name)
    this.setText('characterShield', hero.shield.item.name)
    this.setText('characterAccessories', hero.accessories.item.name)
